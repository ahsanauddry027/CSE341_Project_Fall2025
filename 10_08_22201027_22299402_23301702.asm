...
.DATA
    ...
    MSG_WELCOME_HDR DB 0Dh, 0Ah, 'Welcome to BRACU Voting Machine', 0Dh, 0Ah, '$'
    MSG_DEVELOPED   DB 'Developed by', 0Dh, 0Ah, '$'
    MSG_AUTHORS     DB 'Ahsan Habib, Imran Ali, Nusaiba Sawda', 0Dh, 0Ah, '$'
    MSG_PRESS_ENT   DB 0Dh, 0Ah, 0Dh, 0Ah, '....PRESS ENTER TO CONTINUE...', '$'
    ...
    VOTER_COUNT     DB 0
    MAX_VOTERS      DB 4
    VOTER_HAS_VOTED DB 5 DUP(0)     
    CANDIDATE_VOTES DB 5 DUP(0)     
    TOTAL_VOTES_CAST DB 0           
    ELECTION_OVER   DB 0            
    ...
    MSG_REG_PASS    DB 0Dh, 0Ah, 'Enter Password for Voter: $'    
    ...
    MSG_VOTE_PW_PRPT DB 0Dh, 0Ah, 'Enter your Password: $'        
    ...
    MSG_EDIT_ID     DB 0Dh, 0Ah, 'Enter Candidate ID to Edit (1-3): $'
...
WELCOME_SCREEN:
    ...
    LEA DX, MSG_WELCOME_HDR
    MOV AH, 09h
    INT 21h
    
    LEA DX, MSG_DEVELOPED
    MOV AH, 09h
    INT 21h
